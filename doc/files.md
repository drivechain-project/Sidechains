...
* bitcoin.conf: contains configuration settings for bitassetsd or bitcoin-qt
* bitassetsd.pid: stores the process id of bitassetsd while running
...
* debug.log: contains debug information and general logging generated by bitassetsd or bitcoin-qt
